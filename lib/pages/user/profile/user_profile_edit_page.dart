...
import 'package:vpomosh/pages/user/profile/get_user_city.dart';

class UserProfileEditPage extends StatefulWidget {

  final FirebaseUser user;
  UserProfileEditPage({this.user});

  @override
  _UserProfileEditPageState createState() => _UserProfileEditPageState(user: this.user);
}

class _UserProfileEditPageState extends State<UserProfileEditPage> {

  final FirebaseUser user;
  _UserProfileEditPageState({this.user});
